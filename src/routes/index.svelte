...
<main class="bg-black text-gray-300 text-3xl w-full h-screen grid content-center justify-center text-center transition-all" in:fade="{{ duration: 1250 }}" out:slide>
